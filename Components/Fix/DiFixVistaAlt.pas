...
procedure Register;
begin
  RegisterComponents('Di.Fix', [TFixVistaAlt]);
end;

{ TFixVistaAlt }

procedure TFixVistaAlt.ApplicationEventsIdle(Sender: TObject;
  var Done: Boolean);
var
  I: Integer;
  J: Integer;
...
constructor TFixVistaAlt.Create(AOwner: TComponent);
begin
  inherited;
  FRepaintAll := True;
...
destructor TFixVistaAlt.Destroy;
begin
...
function TFixVistaAlt.VistaWithTheme: Boolean;
var
